...
while true; do
  ...
  # 输出到终�?  
  echo "$datetime   ChargePercentage: $battery_ChargePercentage%   Voltage: $battery_Voltage   OnBattery: $battery_OnBattery   UpTimeCpuFree: $uptime_cpufree   CPU_temperature: $temperature"
